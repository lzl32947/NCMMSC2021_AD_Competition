...
class AldsDataset(Dataset):
    ...
    def pre_emphasis(self, signal, coefficient=0.95):
        ...
        pre = np.append(signal[0], signal[1:] - coefficient * signal[:-1])
