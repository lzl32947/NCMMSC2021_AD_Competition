...
class ExtractionModel(nn.Module):
    def __init__(self):
        ...
        self.b_lstm_layer_1 = nn.LSTM(input_size=, hidden_size=30,num_layers=1, bidirectional=True)
        self.b_lstm_layer_2 = nn.LSTM(input_size=, hidden_size=20, num_layers=1, bidirectional=True)
        ...
        self._normal_init(self.b_lstm_layer_1, 0, 0.01)
        self._normal_init(self.b_lstm_layer_2, 0, 0.01)
    ...
    def forward(self, input_tensor: torch.Tensor):
        ...
        output, (hn, cn) = self.b_lstm_layer_1(output, (h0, c0))

        h0 = torch.randn(2, 20)  # [bidirection*num_layers,batch_size,hidden_size]
        c0 = torch.randn(2, 20)  # [bidirection*num_layers,batch_size,hidden_size]
        output, (hn, cn) = self.b_lstm_layer_2(output, (h0, c0))
