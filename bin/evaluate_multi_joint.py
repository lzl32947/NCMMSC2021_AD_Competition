...
if __name__ == '__main__':
    ...
    model_list = [
        {"model_name": "CompetitionSpecificTrainVggNet16BNBackboneLongModel",
         "weight_identifier": "competition_20210918_192703",
         "input_channels": 3,
        ...
        {"model_name": "CompetitionSpecificTrainVggNet19BNBackboneLongModel",
         "weight_identifier": "competition_20210918_213358",
         "input_channels": 3,
         "use_features": AudioFeatures.SPECS,
         "weight_description": None,
         "joint": False},
